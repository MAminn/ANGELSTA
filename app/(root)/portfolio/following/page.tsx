      ...
      <div className=" w-[950px] h-[640px]  flex-col justify-center items-center">
        <div className=" h-[510px] bg-white flex justify-center items-center mt-[50px]  ">
          <div className=" flex-col justify-center items-center gap-8">
            <h1 className=" text-center mb-6 text-[1.75rem] font-semibold max-lg:text-xl">
              Follow your first company here:
            </h1>

            <button
              onClick={toggleMenu}
              className="btn-custom ml-[150px] max-lg:ml-[80px] "
            >
              Follow Company
            </button>
            ...
            <div
              ref={menuRef}
              className={`fixed top-1/2 left-1/2 max-lg:top-[400px] h-[280px] max-lg:h-[330px] w-[800px] bg-white shadow-lg transform transition-all duration-500 ease-in-out max-lg:w-full max-lg:max-w-[430px] ${
                isOpen
            ...
            >
              ...
              <div className="pl-[40px] pt-4 pr-8">
                ...
                <div className=" right-[20px] absolute mt-4 max-lg:mt-[30px] max-lg:flex max-lg:flex-col max-lg:justify-center max-lg:items-center max-lg:gap-0">
                  <Link
                    href=""
                    type="submit"
