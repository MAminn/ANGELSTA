      ...
      <div className=" w-[950px] h-[640px]  flex-col justify-center items-center">
        ...
        <div className=" h-[510px] bg-white flex justify-center items-center  ">
          <div className=" flex-col justify-center items-center gap-8">
            ...
            <div
              ref={menuRef}
              className={`fixed top-1/2 left-1/2 h-[600px] max-lg:h-[720px] w-[800px] bg-white shadow-lg transform transition-all duration-500 ease-in-out max-lg:w-full max-lg:max-w-[430px] ${
                isOpen
            ...
            >
              ...
              <div className="pl-[40px] pt-4 pr-8">
                ...
                <div className=" right-[20px] absolute mt-4 max-lg:mt-[10px] max-lg:flex max-lg:flex-col max-lg:justify-center max-lg:items-center max-lg:gap-0">
                  <Link
                    href=""
                    type="submit"
                  ...
                  <Link
                    href=""
                    type="submit"
                    className="btn-custom rounded-md transition-all duration-300 ease-in-out hover:bg-white hover:text-[#0160ff] w-[400px] px-[200px] py-3 max-lg:px-[100px] max-lg:mt-[20px] max-lg:flex max-lg:justify-center max-lg:items-center"
                  >
