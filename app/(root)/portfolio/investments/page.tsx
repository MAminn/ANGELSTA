...
const InvestorPage = () => {
  ...
  return (
    <div className="flex justify-center items-center bg-[#E3E8EC] p-[5rem] max-md:w-full">
      <div className="w-[950px] h-[640px]  flex-col justify-center items-center">
        ...
        <div className=" h-[510px] bg-white flex justify-center items-center max-lg:flex-wrap  ">
          <div className=" flex-col justify-center items-center gap-8 ">
            <p className=" max-w-[500px]  text-center mb-6 text-[1.25rem] max-lg:text-base max-lg:max-w-[250px] max-lg:pl-6">
            ...
            <button
              onClick={toggleMenu}
              className="btn-custom ml-[170px] max-lg:ml-12 "
            >
              Create Portfolio
            </button>
            ...
            <div
              ref={menuRef}
              className={`fixed top-1/2 left-1/2 h-[600px] max-lg:h-[800px] w-[800px] bg-white shadow-lg transform transition-all duration-500 ease-in-out max-lg:w-full max-lg:max-w-[430px] ${
                isOpen
            ...
            >
              ...
              <div className="pl-[40px] pt-4 pr-8">
                ...
                {/* Submit button */}
                <div className=" right-[20px] absolute mt-4 max-lg:mt-[50px] max-lg:flex max-lg:flex-col max-lg:justify-center max-lg:items-center max-lg:gap-0">
                  <Link
                    href=""
                    type="submit"
                  ...
                  <Link
                    href=""
                    type="submit"
                    className="btn-custom rounded-md transition-all duration-300 ease-in-out hover:bg-white hover:text-[#0160ff] w-[400px] px-[200px] py-3 max-lg:px-[100px] max-lg:mt-[50px] max-lg:flex max-lg:justify-center max-lg:items-center"
                  >
