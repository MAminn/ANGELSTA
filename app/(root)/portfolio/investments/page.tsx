...
const InvestorPage = () => {
  ...
  return (
    <div className="flex justify-center items-center bg-[#E3E8EC] max-md:p-[2rem] p-[5rem] max-md:w-full">
      <div className="w-full h-full flex-col justify-center items-center">
        ...
        <div className=" h-[510px] bg-white flex justify-center items-center max-md:items-start max-lg:flex-wrap max-md:h-full max-md:px-4 max-md:pb-4   ">
          <div className=" flex-col justify-center items-center gap-8 ">
            ...
            <div className="h-[2px] bg-gray-300 mb-6 max-md:mb-1"></div>
            <p className=" max-w-[500px] text-center mb-10 max-lg:text-base max-lg:max-w-[250px] max-lg:pl-6 max-md:text-xs max-md:p-4 max-md:mb-2">
            ...
            <button
              onClick={toggleMenu}
              className="btn-custom ml-[170px] max-md:ml-0 max-md:w-full max-sm:py-2 max-sm:px-4 max-lg:ml-[50px] max-sm:text-[10px] "
            >
              Create Portfolio
            </button>
            ...
            <div
              ref={menuRef}
              className={`fixed top-[50%] left-1/2 h-[600px] max-lg:h-[800px] w-[800px] bg-white shadow-lg transform transition-all duration-500 ease-in-out max-lg:w-full max-lg:max-w-[430px] ${
                isOpen
            ...
            >
              ...
              <div className="px-[40px] pt-4  relative">
                ...
                {/* Submit button */}
                <div className=" right-[20px]  mt-4 max-lg:mt-[50px] max-lg:flex max-lg:flex-col max-lg:justify-center max-lg:items-center max-lg:gap-0 max-md:mt-0">
                  <Link
                    href=""
                    type="submit"
                  ...
                  <Link
                    href=""
                    type="submit"
                    className="btn-custom rounded-md transition-all duration-300 ease-in-out hover:bg-white hover:text-[#0160ff] w-[400px] px-[200px] py-3 max-lg:px-[100px] max-lg:mt-[50px] max-lg:flex max-lg:justify-center max-lg:items-center max-md:mt-[15px] max-md:w-[250px]"
                  >
