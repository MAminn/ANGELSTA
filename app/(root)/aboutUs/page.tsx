...
const Page = () => {
  return (
    <div className=' flex flex-col justify-center items-center  gap-16 h-full w-full'>
      ...
      <div className=' w-full h-[350px] bg-[#ffffff2d]ext-white flex justify-center items-center gap-14 max-lg:flex-col max-lg:bg-[#FFFFFF] max-lg:pb-10 max-lg:gap-0 max-lg:mt-[150px]'>
