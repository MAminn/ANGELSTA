  ...
  return (
    <div className=' flex flex-col justify-center items-center  h-full w-full mt-[150px]  max-lg:mx-0 max-lg:w-[430px]    '>
        ...
        <div className='lg:bg-hero h-[600px] w-[1100px] bg-no-repeat bg-center bg-contain flex justify-center items-start max-lg:w-[430px] max-lg:h-[335px] max-lg:flex-col max-lg:justify-center max-lg:items-center max-lg:bg-heroMobile max-lg:bg-top max-lg:bg-[length:380px_70px]  '>
          <div className=' flex-col justify-center items-center mt-[150px] max-lg:mt-0 max-lg:px-[10px]'>
            <h1 className=' mb-10 max-lg:mb-4 text-[3.75rem] leading-4 max-lg:text-[1.875rem] max-lg:font-semibold max-lg:leading-[.91] max-lg:text-center '>
              <span className=' text-[#946bad]'>Raise</span>
              <span className=' text-[#4D4D4D] ml-3 font-semibold'>
                Capital
              </span>
            </h1>
            ...
            <Link href='/form/onboarding' className=' ml-16'>
              <button className=' text-[#fefefe] no-underline font-semibold pl-4 pr-4 pt-4 pb-4 w-[250px] h-[65px] bg-[#946bad] rounded-lg uppercase transition-all duration-300 hover:bg-[#664779] max-lg:py-2 max-lg:w-[180px] max-lg:h-[50px] max-lg:ml-9'>
                get started
              </button>
            </Link>
          </div>
          ...
          <div className=' w-[430px] h-[380px] max-lg:w-[400px] max-lg:h-[260px]'>
            ...
            <div className=' mt-[50px]'>
              <Link href='/form/onboarding'>
                <button className=' text-[#fefefe] no-underline font-semibold pl-4 pr-4 pt-4 pb-4 w-[250px] h-[65px] bg-[#946bad] rounded-lg uppercase transition-all duration-300 hover:bg-[#664779]       max-lg:py-2 max-lg:w-[180px] max-lg:h-[50px] max-lg:ml-[115px]'>
                  get started
                </button>
              </Link>
            </div>
      ...
      <div className=' flex justify-center items-center w-full h-[400px] mt-[50px] max-lg:w-[400px] max-lg:h-[250px] max-lg:mt-[200px] max-lg:ml-3'>
        <div className=' flex justify-center items-center w-full h-[300px] bg-[#1A83CA] rounded-3xl max-lg:w-[400px] max-lg:h-[220px]'>
          <div className=' flex justify-center items-center w-full h-full'>
            <div className=''>
              ...
              <Link href='/form/onboarding'>
                <button className=' text-[#946bad] tracking-wider  no-underline font-semibold pl-4 pr-4 pt-4 pb-4 w-[260px] h-[50px] bg-white rounded-lg uppercase ml-[100px] transition-all duration-300 hover:bg-[#1A83CA] hover:border hover:border-white hover:text-white max-lg:ml-[50px]'>
