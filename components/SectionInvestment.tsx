  ...
  return (
    <section className="pt-0 pb-8 overflow-hidden lg:pt-8">
      <div className="relative w-full mx-auto lg:max-w-6xl xl:max-w-7xl mt-8">
        <div className="absolute top-0 hidden w-3/4 h-full -ml-48 bg-[#0b272d] lg:block lg:-left-72 xl:-left-96"></div>
        <div className="relative grid grid-cols-12 gap-0">
          ...
          <div className="relative col-span-12 px-8 py-20 mx-auto bg-[#0b272d] lg:max-w-4xl lg:pr-16 lg:rounded-r-lg 2xl:pl-0 xl:mx-0 xl:col-span-7">
            <h1 className="text-5xl font-bold text-[#d1d6d6] md:text-6xl">
      ...
      <div className="relative px-8 py-8 space-y-8">
        ...
        <div className="mx-auto space-y-2 max-w-7xl">
          ...
          <div className="px-12 py-8 text-center bg-[#0b272d] rounded-sm">
