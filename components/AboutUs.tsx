      ...
      <div className='max-w-[1240px] mx-auto grid md:grid-cols-2 max-md:gap-6'>
        ...
        <div className="flex justify-center items-center">
          <div className='flex flex-col py-4 gap-4 max-md:text-center'>
            ...
            <Link href='/aboutUs'>
              <button className='font-bold bg-[#000000] text-white rounded-full py-3 px-5 transform hover:scale-110 hover:text-white transition ease-out duration-300 mt-4'>
                Learn More
              </button>
            </Link>
          </div>
