...
const Page = () => {
  return (
    <div className=" flex flex-col justify-center items-center  gap-16 h-full w-full">
      <div className=" mt-[100px] flex justify-between items-center  w-full h-[480px] bg-[#ebf5ff] max-lg:flex-col ">
        <div className=" flex flex-col justify-center items-start gap-6 pl-[400px] max-lg:pl-[20px] max-lg:p-10 max-lg:justify-around max-lg:gap-0 max-lg:items-start">
          ...
          <Link
            href=""
            className="btn-custom-2 px-5 max-lg:px-[120px] py-1.5 transition-all duration-300 ease-in-out hover:bg-white hover:text-[#0160ff] max-lg:ml-[30px] "
          >
            Get Pricing
          </Link>
        </div>
      ...
      <div className=" flex flex-col justify-center items-center w-full h-[430px] max-lg:mt-[350px] max-lg:p-8 max-lg:items-start">
        ...
        <h1 className="text-[36px] font-extrabold leading-[3rem] mb-[25px] max-w-[600px] max-lg:font-semibold max-lg:max-w-[380px] max-lg:text-[28px]">
          It started with CTRL+F
        </h1>
        <p className=" max-w-[1100px] text-center mb-[25px]">
          CEO and Founder, <span className=" font-semibold">Jack Kokko </span>,
        ...
        <p className=" max-w-[1100px] text-center mb-[16px]">
          ...
          <span className=" font-semibold">Raj Neervannan</span>, and they were
          both shocked to realize that the research process and tools available
          hadn’t changed after all this time. In 2011, Jack and Raj sought to
          solve this problem by launching AlphaSense, a new type of search
          engine that leverages machine learning and natural language processing
          technology to enable professionals to cut through the noise and easily
          extract insights from thousands of sources and billions of data
          points.
        </p>
      </div>
      <div className=" flex justify-between items-center  w-full h-[480px] bg-[#eff3f5] max-lg:flex-col max-lg:justify-center max-lg:items-center max-lg:mt-[70px] max-lg:h-full ">
        ...
        <div className=" flex flex-col justify-center items-start gap-6 p-8 pr-[300px] max-lg:pr-0 max-lg:p-8 max-lg:gap-0">
          ...
          <h1 className="text-[2.75rem] font-bold leading-[3rem] mb-[25px] max-w-[600px] max-lg:text-[28px] max-lg:leading-[32px]">
          ...
          <Link
            href=""
            className="btn-custom-2 px-5 py-1.5 transition-all duration-300 ease-in-out hover:bg-white hover:text-[#0160ff] "
          >
      ...
      <div className=" flex flex-col justify-start items-center w-full h-full my-[50px]">
        <p className=" text-[36px] font-bold mb-[20px]">Meet our Team</p>
        <div className=" flex flex-col justify-center items-center gap-4">
          <p className="  text-[24px] font-semibold border-b-[#0160ff] border-b-4 ">
            Leadership
          </p>
      ...
      <div className=" w-full h-[350px] bg-[#ffffff2d] flex justify-center items-center gap-14 max-lg:flex-col max-lg:bg-[#FFFFFF] max-lg:pb-10 max-lg:gap-0 max-lg:mt-[150px]">
      ...
      <div className=" flex flex-col justify-center gap-6 items-center w-full h-[380px] bg-[#001765]">
